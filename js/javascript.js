...
//Criação da Primeira matriz
  linhas1 =  prompt("Digite a quantidade de linhas da primeira matriz: ");
  colunas1 =  prompt("Digite a quantidade de colunas da primeira matriz: ")
  ...
  for( var l = 0; l < linhas1; l++){
      for( var c = 0; c < colunas1; c++){
          matriz [l] [c] = prompt( "Digite o valor da posição " + l + " " + c);
      }
  }

//Criação da Primeira matriz
  linhas2 =  prompt("Digite a quantidade de linhas 2 da primeira matriz: ");
  colunas2 =  prompt("Digite a quantidade de colunas 2 da primeira matriz: ")
  ...
  for(var l2 = 0; l2 < linhas2; l2++){
      for(var c2 = 0; c2 < colunas2; c2++){
          matriz2 [l2] [c2] = prompt( "Digite o valor da posição " + l2 + " " + c2);
      }
  }
